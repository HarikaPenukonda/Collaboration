...
public class JobController {
	private static final Logger logger	= LoggerFactory.getLogger(JobController.class);
	  ...
	  @Autowired
		...
		public ResponseEntity<Job> getJobDetails(@RequestParam("jobID") String job_id){
		...
		public ResponseEntity<JobApplication> applyForJob(@RequestParam("jobID") String job_id,HttpSession httpSession){
		...
		public ResponseEntity<JobApplication> selectUser(@RequestParam("userID") String userID,@RequestParam("jobID") int jobID ){
		...
		public ResponseEntity<JobApplication> canCallForInterview(@RequestParam("userID") String userID,@RequestParam("jobID") int jobID ){
		...
		public ResponseEntity<JobApplication> rejectJobApplication(@RequestParam("userID") String userID,@RequestParam("jobID") int jobID ){
